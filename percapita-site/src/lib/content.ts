...
export const PHOTOS = {
  hero: {
    // Client-supplied, Sept 2026, stored at its delivered 692x640 so the
    // framing stays adjustable - Hero sets objectPosition rather than the
    // crop being baked in. The slot renders 536x640, which is 1072x1280 on a
    // retina screen, so this shows at roughly twice its real resolution. Ask
    // for the original at 1400x1750 or larger. See OPEN-ITEMS.md.
    src: "/photos/hero.jpg",
    alt: "A couple reviewing their investments together on a laptop at home",
  },
  quote: {
